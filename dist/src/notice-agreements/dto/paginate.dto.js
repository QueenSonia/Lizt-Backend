...
const create_notice_agreement_dto_1 = require("./create-notice-agreement.dto");
...
class PaginationResponseDto {
    ...
    pagination;
    static _OPENAPI_METADATA_FACTORY() {
        return { notice_agreements: { required: true, type: () => [require("./create-notice-agreement.dto").CreateNoticeAgreementDto] }, pagination: { required: true, type: () => require("./paginate.dto").PaginationMetadataDto } };
    }
}
...
], PaginationResponseDto.prototype, "notice_agreements", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
