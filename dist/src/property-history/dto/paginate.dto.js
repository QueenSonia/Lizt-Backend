...
class PaginationResponseDto {
    ...
    pagination;
    static _OPENAPI_METADATA_FACTORY() {
        return { property_histories: { required: true, type: () => [require("../entities/property-history.entity").PropertyHistory] }, pagination: { required: true, type: () => require("./paginate.dto").PaginationMetadataDto } };
    }
}
exports.PaginationResponseDto = PaginationResponseDto;
__decorate([
    (0, swagger_1.ApiProperty)({
        type: [property_history_entity_1.PropertyHistory],
        description: 'Array of property history objects',
    }),
    __metadata("design:type", Array)
], PaginationResponseDto.prototype, "property_histories", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
