...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 100, description: 'The total number of users' }),
    __metadata("design:type", Number)
], PaginationMetadataDto.prototype, "totalRows", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 10, description: 'Number of users per page' }),
    __metadata("design:type", Number)
...
class PaginationResponseDto {
    ...
    pagination;
    static _OPENAPI_METADATA_FACTORY() {
        return { users: { required: true, type: () => [require("./create-user.dto").CreateUserDto] }, pagination: { required: true, type: () => require("./paginate.dto").PaginationMetadataDto } };
    }
}
exports.PaginationResponseDto = PaginationResponseDto;
__decorate([
    (0, swagger_1.ApiProperty)({ type: [create_user_dto_1.CreateUserDto], description: 'Array of user objects' }),
