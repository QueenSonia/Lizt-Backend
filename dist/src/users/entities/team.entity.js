...
let Team = class Team extends base_entity_1.BaseEntity {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, creator_id: { required: true, type: () => String }, members: { required: true, type: () => [require("./team-member.entity").TeamMember] } };
    }
};
exports.Team = Team;
__decorate([
...
__decorate([
    (0, typeorm_1.Column)({ nullable: false, type: 'varchar' }),
    __metadata("design:type", String)
], Team.prototype, "creator_id", void 0);
__decorate([
